  ...
  <div class="mt-14 max-w-xl inset-0 mx-auto">
    <div class="mb-4 justify-center h-8 flex gap-3">
      <div class="relative flex-1 min-w-0">
        ...
        <label for="project-name" class="absolute -top-7 -left-1 w-full h-8 inset-0 mx-auto peer-focus:-top-7 peer-focus:-left-1 text-sm peer-focus:text-sm text-blue-500 peer-focus:text-blue-500 peer-placeholder-shown:left-0.5 peer-placeholder-shown:top-0.5 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 font-bold transition-all">您的專案名稱</label>
      </div>
    ...
    <div class="text-center">
      <button class="bg-green-600 border-0 px-4 py-2 text-lg rounded-lg inset-0 mx-auto hover:scale-110 active:scale-90 transition-all text-white disabled:bg-gray-500 disabled:hover:scale-100" @click="$emit('copy')" :disabled="invalid">
        按我複製 !
      </button>
    </div>
  </div>
